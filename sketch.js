...
function draw() {
  ...
  background("white");
  textSize(30)
  text("L I V E S "+Lives,600,50)
  if(keyDown("q")|| keyDown("e")|| keyDown("r")|| keyDown("t")|| keyDown("y")|| keyDown("u")|| keyDown("i")|| keyDown("o")|| keyDown("s")|| keyDown("d")|| keyDown("f")|| keyDown("h")|| keyDown("j")|| keyDown("k")|| keyDown("l")|| keyDown("z")|| keyDown("x")|| keyDown("c")|| keyDown("v")|| keyDown("b")|| keyDown("n")){
	  ...
	  if(Lives<=0){
		textSize(100)  
		fill("red")
		text("YoU loST, hoW aRE YoU So BAd", 0.1,100)
		Man.visible = false
	    Man2.visible = false
	    PoliceMan.visible = false
	    RobloxArmyMan.visible = false
